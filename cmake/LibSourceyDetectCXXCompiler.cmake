...
#  see  include/LibSourcey/cxtypes.h file for related   ICC & LibSourcey_ICC defines.
# NOTE: The system needs to determine if the '-fPIC' option needs to be added
#  for the 3rdparty static libs being compiled.  The CMakeLists.txt files
#  in 3rdparty use the LibSourcey_ICC definition being set here to determine if
#  the -fPIC flag should be used.
# ----------------------------------------------------------------------------
if(UNIX)
    if  (__ICL)
        set(LibSourcey_ICC   __ICL)
    elseif(__ICC)
        set(LibSourcey_ICC   __ICC)
    elseif(__ECL)
        set(LibSourcey_ICC   __ECL)
    elseif(__ECC)
        set(LibSourcey_ICC   __ECC)
    elseif(__INTEL_COMPILER)
        set(LibSourcey_ICC   __INTEL_COMPILER)
    elseif(CMAKE_C_COMPILER MATCHES "icc")
        set(LibSourcey_ICC   icc_matches_c_compiler)
    endif()
endif()

if(MSVC AND CMAKE_C_COMPILER MATCHES "icc")
    set(LibSourcey_ICC   __INTEL_COMPILER_FOR_WINDOWS)
endif()
...
if(CMAKE_COMPILER_IS_GNUCXX)
    ...
    if(NOT CMAKE_GCC_REGEX_VERSION)
      string(REGEX MATCH "[0-9]+.[0-9]+" CMAKE_GCC_REGEX_VERSION "${CMAKE_LibSourcey_GCC_VERSION_FULL}")
    endif()
