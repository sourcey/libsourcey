...
macro(print_module_variables name)
    message("${name} Variables:")
    if (${name}_INCLUDE_DIRS)
      message("-- Include Dirs: ${${name}_INCLUDE_DIRS}")
    else()
      message("-- Include Dir: ${${name}_INCLUDE_DIR}")
    endif()
    if (${name}_LIBRARIES)
      message("-- Libraries: ${${name}_LIBRARIES}")
    else()
      message("-- Library: ${${name}_LIBRARY}")
    endif()
    message("-- Debug Library: ${${name}_LIBRARY_DEBUG}")
    message("-- Release Library: ${${name}_LIBRARY_RELEASE}")
    message("-- Dependencies: ${${name}_DEPENDENCIES}")
