...
macro(ask_build_sourcey_dependency name)
  ...
  if(BUILD_DEPENDENCY_${name})    
    set(LibSourcey_BUILD_DEPENDENCIES ${LibSourcey_BUILD_DEPENDENCIES} ${name})   
    set(LibSourcey_BUILD_DEPENDENCIES ${LibSourcey_BUILD_DEPENDENCIES} PARENT_SCOPE)
  endif()    
...
macro(ask_build_sourcey_module name)
  ...
  if(BUILD_MODULE_${name})
    set(LibSourcey_BUILD_MODULES ${LibSourcey_BUILD_MODULES} ${name})   
...
macro(ask_build_sourcey_application name)
  ...
  if(BUILD_APPLICATION_${name})
    set(LibSourcey_BUILD_APPLICATIONS ${LibSourcey_BUILD_APPLICATIONS} ${name})   
    set(LibSourcey_BUILD_APPLICATIONS ${LibSourcey_BUILD_APPLICATIONS} PARENT_SCOPE)
  endif()    
