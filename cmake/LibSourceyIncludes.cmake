...
macro(add_dependency_build_variables name)
  ...
  if(${name}_DEPENDENCIES)
    ...
    #list(APPEND LibSourcey_BUILD_DEPENDENCIES ${${name}_DEPENDENCIES})
  endif()
