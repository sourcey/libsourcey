# ----------------------------------------------------------------------
# This macro allows inclusion of 3rd party dependency into a project
# ----------------------------------------------------------------------
macro(include_dependency name)
  ...
  if(${var_root}_FOUND)
    ...
    STRING(TOUPPER ${var_root} var_root)    
    if(${var_root}_FOUND)
      set(lib_found 1)
    endif()
  endif()  
  ...
  if(${var_root}_LIBRARY)
    ...
    set(LibSourcey_INCLUDE_LIBRARIES ${LibSourcey_INCLUDE_LIBRARIES} ${${var_root}_LIBRARY})
  endif()
  if(${var_root}_LIBRARIES)
    message(STATUS "### Found ${name} Libs: ${${var_root}_LIBRARIES}")
    set(LibSourcey_INCLUDE_LIBRARIES ${LibSourcey_INCLUDE_LIBRARIES} ${${var_root}_LIBRARIES})
  endif()
endmacro()