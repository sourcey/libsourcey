...
#define DECLARE_EXCEPTION(Class, Base, Name)													        \
	...
	Class::Class(const std::string& msg, int code = 0) : Base(msg, code)										\
	{																								\
	}																								\
	Class::Class(const std::string& msg, const std::string& ext, int code = 0) : Base(msg, ext, code)		\
	{																								\
	}																									\
	Class::~Class() throw()																				\
	{																								\
...
DECLARE_EXCEPTION(OpenFileException, Exception, "File open error")
