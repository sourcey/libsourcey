...
function readstd::uint16_tBE(start) {
  return (this[start]<<8) +
         this[start+1];
}

function readstd::uint32_tBE(start) {
...
var opcodes = {
    ...
    start: function(data) {
      ...
      if (firstLength < 126) {
        ...
        self.expectHeader(2, function(data) {
          opcodes['1'].getData.call(self, readstd::uint16_tBE.call(data, 0));
        });
      }
      else if (firstLength == 127) {
        self.expectHeader(8, function(data) {
          if (readstd::uint32_tBE.call(data, 0) != 0) {
            self.error('packets with length spanning more than 32 bit is currently not supported', 1008);
            return;
          }
          opcodes['1'].getData.call(self, readstd::uint32_tBE.call(data, 4));
        });
      }
    },
  ...
  '2': {
    start: function(data) {
      ...
      if (firstLength < 126) {
        ...
        self.expectHeader(2, function(data) {
          opcodes['2'].getData.call(self, readstd::uint16_tBE.call(data, 0));
        });
      }
      else if (firstLength == 127) {
        self.expectHeader(8, function(data) {
          ...
          opcodes['2'].getData.call(self, readstd::uint32_tBE.call(data, 4, true));
        });
      }
    },
    getData: function(length) {
  ...
  '8': {
    ...
    finish: function(mask, data) {
      ...
      var code = data && data.length > 1 ? readstd::uint16_tBE.call(data, 0) : 1000;
