...
Sender.prototype.close = function(code, data, mask) {
  ...
  writestd::uint16_tBE.call(dataBuffer, code, 0);
...
Sender.prototype.frameAndSend = function(opcode, data, finalFragment, maskData, cb) {
  ...
  switch (secondByte) {
    case 126:
      writestd::uint16_tBE.call(outputBuffer, dataLength, 2);
      break;
    case 127:
      writestd::uint32_tBE.call(outputBuffer, 0, 2);
      writestd::uint32_tBE.call(outputBuffer, dataLength, 6);
  }
...
function writestd::uint16_tBE(value, offset) {
  this[offset] = (value & 0xff00)>>8;
  this[offset+1] = value & 0xff;
}

function writestd::uint32_tBE(value, offset) {
