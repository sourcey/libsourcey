...
class PackageManagerConsole: public Sourcey::TaskRunner, public PackageManager
{
public:
	PackageManagerConsole(const PackageManager::Options& options) :
		PackageManager(*this, options)
	{
	}
...
//private:
	//PackageManager packageManager; //::PackageManager(TaskRunner& runner, const Options& options)
	//ICE::MediaStream*		_stream;
};
...
int main(int argc, char** argv)
{
	...
	*/
	...
	{	
		...
		// Set Active Packages
		if (o == 'A') {	
			cout << "Enter packages names seperated by commas: " << endl;
			string s;
			getline(cin,s);
			packages = split(s, ",");
		}
